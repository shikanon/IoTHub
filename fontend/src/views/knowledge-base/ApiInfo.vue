            ...
            <el-container>
                <el-aside width="auto">
                      <el-tabs tab-position="left" style="height: 100%;"  @tab-click="clickApiName">
                        <el-tab-pane  v-for="(item,key) in apiList" :key="key" :label="item.ApiName" :apiId="item.ApiId"></el-tab-pane>          
                    </el-tabs>                  
                </el-aside>
                <el-main>
                    <div>
                        ...
                        <el-collapse v-model="activeNames" >
                            ...
                            <el-collapse-item title="请求实例" name="4">
                             ...
                             <el-collapse-item title="正常返回示例" name="5">
                                   <JsonView :data="JSON.parse(apiInfo.ResultSample)"></JsonView>
                            </el-collapse-item>
                             <el-collapse-item title="失败返回示例" name="6">
                                 <JsonView :data="JSON.parse(apiInfo.FailResultSample)"></JsonView>                              
                            </el-collapse-item>
